...
def build_candidate_analysis_prompt(files: list[FileContent], candidates: list[ApiCallCandidate]) -> str:
    ...
    return (
        ...
        "POST/PUT/PATCH requests may include guarded executable browser_console PoC.\n"
        "Guarded executable PoC must include CONFIRM_AUTHORIZED_TEST = false by default.\n"
        "The request must execute only after the user changes CONFIRM_AUTHORIZED_TEST to true.\n"
