    ...
    def test_candidate_prompt_includes_compact_normalized_manifest_summary(self):
        ...
        project = ProjectUnderstandingResult(
            ...
            normalized_manifest=[SourceFileManifest(
                ...
                runtime_value_sources=[{'line': 9, 'kind': 'json_storage', 'storage': 'sessionStorage', 'key': 'user'}],
                dom_sources=[{'line': 11, 'source': 'location.search', 'variable': 'q', 'raw_source': 'RAW_SOURCE_SHOULD_NOT_APPEAR'}],
