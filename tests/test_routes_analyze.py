...
class RoutesAnalyzeTests(unittest.TestCase):
    ...
    def test_analyze_success_returns_full_structure(self):
        ...
        try:
            ...
            self.assertIn('executive_findings', body['readable_analysis'])
            self.assertIn('verification_playbooks', body['readable_analysis'])
            self.assertIn('review_candidates', body['readable_analysis'])
    ...
    def test_analyze_with_openai_backend_returns_400(self):
